# Description:
This game is created for eudcational purposes only and will not be commercialized, thus the game falls under the educational fair use exception disclamer (listed in the github as a file). Below are citations of free images that have associated attributions.
